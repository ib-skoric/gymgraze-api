...
describe UserController do
  before(:all) do
    @user = FactoryBot.build(:user, email: "testing", password: "testing2313543435", id: 4)
  end
  ...
  describe "POST to /users endpoint" do
    it "creates a new user" do
      post 'create', params: { user: { email: "testing@test.com", password: "testing2313543435", name: "Tester", age: 35, weight: 80, height: 170 } }
  ...
  describe "POST to /request_reset_password endpoint" do
    ...
    it "should send a reset password email" do
      request.headers.merge!(authentication_helper(@user))
      post 'request_password_reset', params: { email: @user.email }
