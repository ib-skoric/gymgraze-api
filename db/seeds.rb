...
Meal.create!(name: "Breakfast", user_id: 1)
Meal.create!(name: "Lunch", user_id: 1)
Meal.create!(name: "Dinner", user_id: 1)
FoodDiaryEntry.create!(date: "2024-03-18", user_id: 1)
Food.create!(name: "Apple", barcode: 3560071269999, food_diary_entry_id: 1, meal_id: 1)
Food.create!(name: "Apple", barcode: 3560071269999, food_diary_entry_id: 2, meal_id: 1)
...
Exercise.create!(name: "Running", exercise_type: "cardio", user_id: 1, workout_id: 1)